...
class _PatientChatPageState extends State<PatientChatPage> {
  ...
  Future<Map> getContactMessages() async{
    ...
    drName = arguments['doctor_name'];
    retrievedData = await F.messagesOfSpecificContactForPatient(chatID) as Map<String, dynamic>;
    messages = retrievedData['messages'];
              ...
              appBar: AppBar(
                ...
                title: Row(
                  children: [
                    IconButton(
                        onPressed: () {
                          Navigator.pushReplacementNamed(context, '/p_messenger');
                        },
                        ...
                        IconButton(
                          ...
                          onPressed: () async{
                            if(messageController.text != ''){
                              ...
                              retrievedData['messages'] = messages;
                              await F.updateContactMessages(retrievedData, chatID);
